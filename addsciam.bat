...
\Python27\python main.py -a http://rss.sciam.com/sciam/60-second-psych --start-date 09/20/14
\Python27\python main.py -a http://rss.sciam.com/sciam/60secsciencepodcast --start-date 10/25/14
